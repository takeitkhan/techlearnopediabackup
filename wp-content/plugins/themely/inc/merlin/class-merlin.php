...
class Merlin {
	...
	function __construct( $config = array(), $strings = array() ) {
		...
		$config = wp_parse_args(
			$config, array(
				'base_path'            => THEMELY_INCLUDES_DIR,
				'base_url'             => THEMELY_INCLUDES_URL,
				'directory'            => 'merlin',
				'merlin_url'           => 'theme-setup-wizard',
				'parent_slug'          => 'themes.php',
				'capability'           => 'manage_options',
				'child_action_btn_url' => '',
				'dev_mode'             => '',
				'ready_big_button_url' => esc_url(get_home_url()),
			)
		);
	 ...
	 * SVG Spinner
	 */
	public function svg_spinner() {

		// Define SVG sprite file.
		$svg_spinner = trailingslashit( $this->base_path ) . $this->directory . '/assets/images/spinner.php';

		// If it exists, include it.
		if ( file_exists( $svg_spinner ) ) {
			require_once apply_filters( 'merlin_svg_spinner', $svg_spinner );
		}
	}
